                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form_barang" >
                                                ...
                                                <input type="file" class="form-control" id="img" name="img" value="{{ old('img', $item->img) }}">
                                                @error('img')
                                                <div class="text-danger mt-2">
                                                    {{ $message }}
                                                </div>
                                                ...
                                                <fieldset class="form-group">
                                                    <select class="form-select" id="basicSelect" name="category_id">
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <option value="{{ $category->id }}" @if(old('category_id', $item->category_id) == $category->id) selected @endif>{{ $category->cat_name }}</option>                                             
                                                        @endforeach
                                                    </select>
                                                </fieldset>
                                                @error('category_id')

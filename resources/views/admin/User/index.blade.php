                            ...
                            <tbody>
                                @foreach ($karyawans as $karyawan )
                                    ...
                                    <td class="d-flex gap-2 flex-wrap">
                                        ...
                                        <form action="{{ route('users.destroy', $karyawan->id) }}" method="post" class="d-flex">
                                            @csrf
                                            @method('DELETE')
                                            <button onclick="return confirm('Yakin untuk menghapus data User ini?')" class="btn btn-danger btn-sm">Delete</button>
                                        </form>                                
                                    </td>
                                </tr>
                                @endforeach
